...
class Emojifier {
    ...
    private static final float EMOJI_SCALE_FACTOR = .7f;
    ...
    static Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture) {
        ...
        if(faces.size() == 0) {
            ...
            for (int i = 0; i < faces.size(); ++i) {
                ...
                int emojiBitmapResource=0;
                switch ( whichEmoji(face) ){
                    case FROWN:{
                        emojiBitmapResource = R.drawable.frown;
                        break;
                    }
                    case CLOSED_EYE_FROWN:{
                        emojiBitmapResource = R.drawable.closed_frown;
                        break;
                    }
                    case CLOSED_EYE_SMILE:{
                        emojiBitmapResource = R.drawable.closed_smile;
                        break;
                    }
                    case LEFT_WINK:{
                        emojiBitmapResource = R.drawable.leftwink;
                        break;
                    }
                    case LEFT_WINK_FROWN:{
                        emojiBitmapResource = R.drawable.leftwinkfrown;
                        break;
                    }
                    case RIGHT_WINK:{
                        emojiBitmapResource = R.drawable.rightwink;
                        break;
                    }
                    case RIGHT_WINK_FROWN:{
                        emojiBitmapResource = R.drawable.rightwinkfrown;
                        break;
                    }
                    case SMILE:{
                        emojiBitmapResource = R.drawable.smile;
                        break;
                    }
                }
                Bitmap emojiBitmap = BitmapFactory.decodeResource(context.getResources(), emojiBitmapResource);
